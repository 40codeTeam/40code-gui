        ...
        const menuBar = (
            ...
            >
                <div className={styles.mainMenu}>
                    <div className={styles.fileGroup}>
                        ...
                        {(this.props.canChangeTheme ||
                            ...
                            <SettingsMenu
                                ...
                                onOpenCustomSettings={this.props.onClickAddonSettings.bind(
                                    null,
                                    'editor-theme3'
                                )}
                                onRequestClose={
                    ...
                    {!window.isElectron && this.props.canRemix && (
                        <div className={classNames(styles.menuBarItem)}>
                            {remixButton}
                        </div>
                    )}
                    ...
                    {!window.isElectron && (
                        <div className={classNames(styles.menuBarItem)}>
                            ...
                            <Button id="save"><FormattedMessage
                                defaultMessage="保存"
                                id="2"
                            /></Button>
                            <Button id="setCover"><FormattedMessage
                                defaultMessage="设置舞台为封面"
                                id="3"
                            /></Button>
                        </div>
                    )}
